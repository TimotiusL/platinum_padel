...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('css/adminlte-docs.css') }}" />
  </head>
  <!--end::Head-->
  <!--begin::Body-->
    ...
    <div class="app-wrapper">
      ...
      <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-brand">
          <a class='brand-link' href='/docs/introduction'>
            <img
        ...
        <div class="sidebar-wrapper">
          <nav class="mt-2" aria-label="Documentation navigation">
            ...
            >
              ...
              <li class="nav-item">
                <a class='nav-link active' href='/docs/layout'>
                  <i class="nav-icon bi bi-grip-horizontal"></i>
                  <p>Layout Classes</p>
                </a>
              </li>
              <li class="nav-item">
                <a class='nav-link' href='/docs/layout-blueprint'>
                  <i class="nav-icon bi bi-diagram-3"></i>
                  <p>Layout Blueprint</p>
                </a>
              </li>
              <li class="nav-item">
                <a class='nav-link' href='/docs/customization'>
                  <i class="nav-icon bi bi-palette"></i>
                  <p>Customization</p>
                </a>
              </li>
              <li class="nav-item">
                <a class='nav-link' href='/docs/color-mode'>
                  <i class="nav-icon bi bi-star-half"></i>
                  <p>Color Mode</p>
                </a>
              </li>
              <li class="nav-item">
                <a class='nav-link' href='/docs/rtl'>
              ...
              <li class="nav-item">
                <a class='nav-link' href='/docs/recipes'>
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a class='nav-link' href='/docs/components/main-header'>
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Main Header</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class='nav-link' href='/docs/components/main-sidebar'>
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Main Sidebar</p>
                    </a>
                  </li>
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a class='nav-link' href='/docs/javascript/plugins-overview'>
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Overview</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class='nav-link' href='/docs/javascript/layout'>
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Layout</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class='nav-link' href='/docs/javascript/pushmenu'>
                      <i class="nav-icon bi bi-circle"></i>
                      <p>PushMenu</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class='nav-link' href='/docs/javascript/treeview'>
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Treeview</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class='nav-link' href='/docs/javascript/card-widget'>
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Card Widget</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class='nav-link' href='/docs/javascript/direct-chat'>
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Direct Chat</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class='nav-link' href='/docs/javascript/fullscreen'>
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Fullscreen</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class='nav-link' href='/docs/javascript/accessibility'>
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Accessibility</p>
                    </a>
                  </li>
              ...
              <li class="nav-item">
                <a class='nav-link' href='/docs/migration'>
                  <i class="nav-icon bi bi-arrow-up-right-square"></i>
                  <p>Migration from v3</p>
                </a>
              </li>
              <li class="nav-item">
                <a class='nav-link' href='/docs/deployment'>
                  <i class="nav-icon bi bi-cloud-upload"></i>
                  <p>Deployment</p>
                </a>
              </li>
              <li class="nav-item">
                <a class='nav-link' href='/docs/browser-support'>
              ...
              <li class="nav-item">
                <a class='nav-link' href='/docs/how-to-contribute'>
                  <i class="nav-icon bi bi-people"></i>
                  <p>Contributing</p>
                </a>
              </li>
              <li class="nav-item">
                <a class='nav-link' href='/docs/license'>
            ...
            <div class="p-3 mt-3 border-top border-secondary border-opacity-25">
              <a class='btn btn-sm btn-outline-light w-100 d-flex align-items-center justify-content-center gap-2' href='/'>
